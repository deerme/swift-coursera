...
struct Frases{
    var frases = ["Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
    ...
    func regresaFraseAleatorio() -> String {
        let posicion : Int = Int(arc4random()) % frases.count
